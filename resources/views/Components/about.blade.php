        ...
        <div class="space-y-6 scroll-animate">
            ...
            <div class="grid grid-cols-2 gap-4 my-6">
                <div class="border-l-2 border-red-600 pl-4">
                    ...
                    <p class="font-semibold">Ravidu Senevirathne</p>
                </div>
                <div class="border-l-2 border-red-600 pl-4">
                ...
                <div class="border-l-2 border-red-600 pl-4">
                    ...
                    <p class="font-semibold">Sri Lanka</p>
                </div>
                <div class="border-l-2 border-red-600 pl-4">
            ...
            <a href="#contact" class="inline-block bg-red-600 hover:bg-red-700 px-6 py-3 rounded-full transition-all duration-300">
                Let's Talk
            </a>
        </div>
            ...
            <div class="space-y-4">
                ...
                {{-- <div class="skill-item">
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="text-red-600">95%</span>
                    </div>
                    <div class="h-2 bg-gray-700 rounded-full">
