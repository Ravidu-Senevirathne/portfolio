...
<footer class="relative min-h-[600px] bg-black overflow-hidden">
    <!-- Background with overlay -->
    <div class="absolute inset-0 z-0">
        <div class="w-full h-full flex justify-center items-center">
            <img src="{{ Vite::asset('resources/images/sitting-me.jpeg') }}" 
                 alt="Footer Background" 
                 class="min-w-[4000px] md:min-w-[5000px] h-[600px] md:h-[800px] object-contain opacity-20">
        </div>
    </div>

    <!-- Content -->
    <div class="relative z-10 container mx-auto px-6 mt-56">
